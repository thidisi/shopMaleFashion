                                        ...
                                        @foreach ($each->infos as $value)
                                            @if ($value->status == ACTIVE)
                                                <label class="@if (head($each->infos)[0]->name == $value->name) active @endif"
                                                    ...
                                                    <input type="hidden" id="wishlist_productsize{{ $each->id }}"
                                                        value="{{ $value->name }}">
                                                </label>
                                            @endif
                                        @endforeach
                                ...
                                <div class="product__details__cart__option">
                                    ...
                                    @if ($each->quantity > 0)
                                        <button class="primary-btn @if (session('sessionIdCustomer') == null) signIn @endif"
                                            ...
                                            @else type="button" data-toggle="modal"
                                            data-target="#loginModal" @endif>add
                                            to
                                            cart
                                        </button>
                                    @else
                                        ...
                                        <div class="product__details__tab__content__item">
                                            <div class="p-2"
                                                ...
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <button type="button"
                                                        class="btn-review @if (session('sessionIdCustomer') == null) signIn @endif"
                                                        @if (session('sessionIdCustomer') !== null) @if (!in_array(session('sessionIdCustomer'), $check_review['customer_id']))
                                                                data-toggle="modal"
                                                                data-target="#centermodal"
                                                            @else
                                                                onClick="alert('Please')" @endif
                                                    ...
                                                    @if (count($show_comments) > 0)
                                                        @foreach ($show_comments as $show_comment)
                                                            <div class="boxComment-item"
                                                                @if ($show_comment->status === NOT_ACTIVE) style="opacity: 0.7;" @endif>
                                                                        ...
                                                                        @if (count($show_comment->parents) > 0)
                                                                            @foreach ($show_comment->parents as $comment_parent)
                                                                                <div class="boxComment-list-item"
                                                                                    @if ($comment_parent->status !== ACTIVE) style="opacity: 0.7;" @endif>
                                                                                    <div
                                                                                        class="boxReview-comment-item-title d-flex justify-content-between align-items-center my-3">
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                class="name_user text-capitalize">{{ $comment_parent->name }}</span>
                                                                                        </div>
                                                                                        <p class="date-time">
