                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <div class="rating">
                                @for ($i = 1; $i <= 5; $i++)
                                    <i class="fa @if ($i <= $rating_avg) fa-star star @else fa-star-o @endif">
                                    </i>
                                @endfor
                            ...
                            <form data-route="{{ route('cart.store') }}" id="cart-form">
                                ...
                                <div class="product__details__cart__option">
                                    ...
                                    @if ($each->quantity > 0)
                                        <button class="primary-btn @if (session('sessionIdCustomer') == null) signIn @endif"
                                            @if (session('sessionIdCustomer') !== null) type="submit" @else type="button" data-toggle="modal" data-target="#loginModal" @endif>add
                                            to
                                            cart
                                        </button>
                                    @else
                            ...
                            <div class="product__details__btns__option">
                                <button class="button_wishlist border-0 p-0" style="background-color: initial"
                                    data-id="{{ $each->id }}"><i class="fa fa-heart"></i> add to wishlist</button>
                    ...
                    <div class="col-lg-12">
                        <div class="product__details__tab">
                            <ul class="nav nav-tabs" role="tablist" style="cursor: pointer;">
                                <li class="nav-item">
                                    <span class="nav-link active" data-toggle="tab" href="#tabs-5"
                                        role="tab">Description</span>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane" id="tabs-6" role="tabpanel">
                                    <div class="product__details__tab__content">
                                        <div class="product__details__tab__content__item">
                                            <div class="p-2"
                                                style="border: 1px solid #e5e7eb;border-radius: 20px;box-shadow: 0px 2px 2px #ccc;">
                                                <div class="d-flex align-items-center p-2">
                                                    <h5 class="">Reviews & Comments {{ $each->name }}</h5>
                                                </div>
                                                <div class="row row-review">
                                                    <div class="d-flex justify-content-center align-items-center flex-column"
                                                        style="width:40%; border-right: 1px solid #cccccc6e;">
                                                        ...
                                                        <div>
                                                            @for ($i = 1; $i <= 5; $i++)
                                                                <div class="icon"
                                                                    ...
                                                                    <i
                                                                        class="fa fa-star @if (!empty($rating_avg)) @if ($i <= $rating_avg) star @endif @endif"></i>
                                                                </div>
                                                            @endfor
                                                        </div>
                                                    ...
                                                    <div class="d-flex flex-column"
                                                        style="justify-content: space-evenly;width:60%">
                                                        @for ($i = 5; $i >= 1; $i--)
                                                            <div class="d-flex align-items-center"
                                                                ...
                                                                <span
                                                                    style="width: 70px;font-size: 0.85rem;">{{ $reviews["$i"] }}
                                                                    review</span>
                                                            </div>
                                                        @endfor
                                                    </div>
                                            ...
                                            @if (session('sessionIdCustomer') == null) signIn @endif"
                                                        @if (session('sessionIdCustomer') !== null) @if (!in_array(session('sessionIdCustomer'), $check_review['customer_id'])) data-toggle="modal" data-target="#centermodal" @else onClick="alert('Bạn đã review sản phẩm này rồi!!')" @endif
                                                    @else data-toggle="modal" data-target="#loginModal" @endif>Review</button>
                                                        ...
                                                        <div class="modal-dialog full-width modal-dialog-centered">
                                                            <div class="modal-content p-0">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('reviewProducts') }}"
                                                                        ...
                                                                        <div
                                                                            class="d-flex align-items-center mb-3 ml-4 mr-4">
                                                                            @for ($count = 1; $count <= 5; $count++)
                                                                                <div class="rating"
                                                                                    style="font-size: 1.5rem;padding:0 12px;"
                                                                                    data-index="{{ $count }}"
                                                                        ...
                                                                        <div class="group-input d-flex mb-3">
                                                                            <input id="image-text" type="text"
                                                                                class="form-control"
                                                                                style="flex: 8;border-bottom-right-radius: 0;border-top-right-radius: 0;"
                                                                                placeholder="Reality image">
                                                                            <input id="image-comments"
                                                                                accept="image/x-png,image/gif,image/jpeg"
                                                                                multiple="multiple" type="file"
                                                                                class="d-none" name="images[]">
                                                                            <label for="image-comments"
                                                                                class=" d-flex align-items-center mb-0 p-2"
                                                                                style="font-size: 0.9rem;flex: 2;height:38px;justify-content: space-evenly;background-color: #cccccc7d;border-bottom-right-radius: 0.25rem;border-top-right-radius: 0.25rem;cursor: pointer;">
                                                                        ...
                                                                        <button type="submit" class="btn-review"
                                                                            style="width: 100%; padding: 5px; font-size: 0.9rem;">Submit
                                                                            review</button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="boxReview-comment my-3 mx-2">
                                                            ...
                                                            @if ($value->status === 'active')
                                                                <div class="boxReview-comment-item">
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <p
                                                                                class="mr-2 d-flex align-items-center justify-content-center name-letter text-uppercase">
                                                                                {{ substr($value->name, 0, 1) }}</p>
                                                                            <span
                                                                                class="name_user text-capitalize">{{ $value->name }}</span>
                                                                        </div>
                                                                    ...
                                                                    <div class="boxReview-comment-item-review my-2 p-2">
                                                                        <div
                                                                            ...
                                                                            <div class="ml-2">
                                                                                @for ($i = 1; $i <= 5; $i++)
                                                                                    <i
                                                                                        class="fa @if ($i <= $value->review) fa-star star @else fa-star-o @endif"></i>
                                                                                @endfor
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                    ...
                                                    @else
                                                        <div
                                                            class="boxReview-no-comment my-2 d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="p-2 mt-3"
                                                style="border: 1px solid #e5e7eb;border-radius: 20px;box-shadow: 0px 2px 2px #ccc;background-color: #f3f4f6;">
                                                <div class="d-flex align-items-center p-2">
                                                    <h5 class="">Ask and answer</h5>
                                                </div>
                                                <div class="comment-form-content">
                                                    <form class="form-group mx-2" data-route="{{ route('addComments') }}"
                                                        id="comment-form">
                                                        @csrf
                                                        ...
                                                        <div class="textarea-comment">
                                                            ...
                                                            <button
                                                                ...
                                                                @if (session('sessionIdCustomer') !== null) type="submit" @else type="button" data-toggle="modal" data-target="#loginModal" @endif>
                                                            ...
                                                            <div class="boxComment-item"
                                                                ...
                                                                <div class="boxComment-content">
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <span
                                                                                class="name_user text-capitalize">{{ $show_comment->name }}</span>
                                                                        </div>
                                                                        <p class="date-time">
                                                                    ...
                                                                    <div class="boxComment-item-form">
                                                                        ...
                                                                        <button
                                                                            @if ($show_comment->status === 'active') onclick="rep_cmt({{ $show_comment->id }})" @endif
                                                                            class="btn-rep-cmt">
                                                                ...
                                                                <form class="form-group mx-2 comment-form2"
                                                                    ...
                                                                    <div id="comment-text-{{ $show_comment->id }}"
                                                                        class="textarea-comment mt-2 d-none"
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" id="wishlist_productimage{{ $value->id }}"
                                    ...
                                    <ul class="product__hover">
                                        ...
                                        <li><a id="wishlist_producturl{{ $value->id }}"
                                                href="{{ route('productDetail', Str::slug($value->name, '-')) }}"><img
                                                    src="{{ asset('frontend/img/icon/search.png') }}" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                                <input type="hidden" id="wishlist_productname{{ $value->id }}"
                                    value="{{ $value->name }}">
                                <div class="product__item__text">
                                    <h6>{{ $value->name }}</h6>
                                    <a href="{{ route('productDetail', Str::slug($value->name, '-')) }}"
                                        class="add-cart">+
                                        Add To Cart</a>
                                    <div class="rating">
                                        @for ($i = 1; $i <= 5; $i++)
