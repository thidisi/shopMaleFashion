        ...
        <div class="row">
            @foreach ($slides as $slide)
                @if ($slide->sort_order == $slideOrders['BANNER'])
                    <div @if ($slide->id % 2 == 0) class="col-lg-7 @if ($slide->id % 3 == 1) offset-lg-4 @endif"
                    @else class="col-lg-5" @endif>
                        <div
                            class="banner__item  @if ($slide->id % 2 != 0) banner__item--middle @endif @if ($slide->id % 3 == 0) banner__item--last @endif">
