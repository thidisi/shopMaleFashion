            ...
            <div class="col-12 mt-2">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <a href="{{ route('admin.discounts.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle mr-2"></i> Add Discounts</a>
                            </div>
                        </div>
                                    ...
                                    @foreach ($discounts as $value)
                                        <tr class="text-center">
                                            ...
                                            <td class="table-action">
                                                <a href="{{ route('admin.discounts.edit', $value->id) }}"
                                                    class="action-icon">
