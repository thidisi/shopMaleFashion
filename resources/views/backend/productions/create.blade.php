                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <textarea id="ckeditor-product" class="form-control" name="descriptions" rows="8"
                                            placeholder="Enter some brief about desciption..">{{ old('descriptions') }}</textarea>
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" data-toggle="select2" id="selectSize">
                                            @foreach ($attrs as $each)
                                                @if (!empty($each->infoAttr) && !empty($each->replace_id))
                                                    <option value="{{ $each->infoAttr }}">
                                                        {{ $each->name }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        </select>
                                        <div class="mt-1"><select class="form-control select2" id="selectSizeValue"
                                                data-toggle="select2" name="attrValues[]" multiple></select></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" data-toggle="select2" name="attrValue">
                                            @foreach ($attrs as $each)
                                                @if (!empty($each->infoAttr) && empty($each->replace_id))
                                                    @foreach ($each->infoAttr as $value)
                                                        <option value="{{ $value->id }}">
                                                            {{ $value->name }}
                                                        </option>
                                                    @endforeach
